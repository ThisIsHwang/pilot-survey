...
class ExperimentRegistryTest(unittest.TestCase):
    def test_registry_contains_numbered_followup_experiments(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                "EXP-028", "EXP-029", "EXP-030", "EXP-031", "EXP-032", "EXP-033",
                "EXP-034",
            ],
        )
    ...
    def test_parent_chain_is_registered(self) -> None:
        ...
        expected = {
            ...
            "EXP-023": "EXP-020", "EXP-024": "EXP-020", "EXP-025": "EXP-024",
            "EXP-026": "EXP-023", "EXP-027": "EXP-024", "EXP-028": "EXP-027",
            "EXP-029": "EXP-024", "EXP-030": "EXP-029", "EXP-031": "EXP-030",
            "EXP-032": "EXP-022", "EXP-033": "EXP-030", "EXP-034": "EXP-021",
        }
